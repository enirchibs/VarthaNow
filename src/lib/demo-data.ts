...
చిన్నపాటి నియమాల ద్వారా మన రోగనిరోధక శక్తిని పెంచుకుని డాక్టర్ వద్దకు వెళ్లే అవసరం లేకుండా జీవించవచ్చు.`,
  ...
  {
    slug: "hyderabad-metro-phase-2-expansion-2026",
    title: "హైదరాబాద్ మెట్రో ఫేజ్-2 పనులకు గ్రీన్ సిగ్నల్: శంషాబాద్ విమానాశ్రయం మరియు శంకర్పల్లి మార్గాలు!",
    excerpt: "హైదరాబాద్ నగరంలో ట్రాఫిక్ సమస్య నివారణకు మెట్రో ఫేజ్-2 విస్తరణపై ప్రభుత్వం కీలక నిర్ణయం తీసుకుంది.",
    content: "## హైదరాబాద్ మెట్రో ఫేజ్-2 వివరాలు\n\nరవాణా సౌకర్యాలను మెరుగుపరచడానికి హైదరాబాద్ శంషాబాద్ ఎయిర్‌పోర్ట్ మరియు హైటెక్ సిటీ కారిడార్లకు మెట్రో లైన్ల పొడిగింపును ఖరారు చేశారు.\n\n## ఐటీ ఉద్యోగులకు భారీ ఉపశమనం\n\nగచ్చిబౌలి, మాదాపూర్ మరియు కోకాపేట ప్రాంతాల్లో ప్రయాణించే ఐటీ నిపుణులకు ఈ విస్తరణ ద్వారా గంటల కొద్దీ వేచి रहने తిప్పలు తప్పుతాయి.",
    category: "telangana",
    tags: ["Hyderabad", "Metro Rail", "Telangana News", "Traffic Solutions"],
    meta_title: "హైదరాబాద్ మెట్రో ఫేజ్-2 విస్తరణ మార్గాలు",
    meta_description: "హైదరాబాద్ ఎయిర్‌పోర్ట్ మెట్రో మార్గాలు, శంషాబాద్ మరియు గచ్చిబౌలి కనెక్టివిటీ తాజా వార్తలు.",
    og_image: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&w=1200&q=80",
    author_name: "VaartaNow Telangana Desk",
    language: "te",
    published: true,
    featured: true,
    reading_time_min: 3,
    published_at: minutesAgo(8)
  },
  {
    slug: "vijayawada-amaravati-expressway-infra",
    title: "విజయవాడ-అమరావతి ఐకానిక్ గ్రీన్ ఎక్స్‌ప్రెస్‌వే: నవనిర్మాణానికి రూ. 3,500 కోట్లు కేటాయింపు!",
    excerpt: "రాజధాని అమరావతి మరియు విజయవాడ నగరాల మధ్య 6-లేన్ గ్రీన్ ఎక్స్‌ప్రెస్‌వే నిర్మాణ పనులకు టెండర్లు ఖరారయ్యాయి.",
    content: "## అమరావతి కనెక్టివిటీ\n\nకృష్ణా నదిపై నూతన వారధి మరియు విజయవాడ బైపాస్ నిర్మాణంతో ప్రయాణ సమయం కేవలం 20 నిమిషాలకు తగ్గనుంది.\n\n## రియల్ ఎస్టేట్ మరియు పరిశ్రమల పురోగతి\n\nతాడేపల్లి, మంగళగిరి మరియు గొల్లపూడి పరిసరాల్లో కొత్త వాణిజ్య కారిడార్లు ఏర్పాటు చేయనున్నారు.",
    category: "andhra-pradesh",
    ...
    featured: true,
    reading_time_min: 4,
    published_at: minutesAgo(14)
  },
  {
    slug: "tirumala-ttd-special-darshan-online-booking",
    title: "తిరుమల తిరుపతి దేవస్థానం: రూ. 300 ప్రత్యేక ప్రవేశ దర్శనం కోటా విడుదల ప్లాన్!",
    excerpt: "శ్రీవారి భక్తులకు నూతన డిజిటల్ టోకెన్ వ్యవస్థ మరియు శీఘ్ర దర్శన వెసులుబాటుపై టీటీడీ అధికారిక ప్రకటన.",
    content: "## టీటీడీ ఆన్‌లైన్ టోకెన్ల విడుదల\n\nభక్తుల సౌకర్యార్థం ప్రతినెలా ఆన్‌లైన్ ద్వారా రూ. 300 దర్శనం టోకెన్లు విడుదల చేయనున్నారు.\n\n## లడ్డూ ప్రసాదం మరియు వసతి\n\nతిరుపతి మరియు తిరుమలలో గదుల ఆన్‌లైన్ బుకింగ్ సిస్టమ్ మరింత పారదర్శకంగా మార్చబడింది.",
    category: "devotional",
    tags: ["Tirupati", "Tirumala", "TTD News", "Special Darshan"],
    meta_title: "టీటీడీ ఆన్‌లైన్ దర్శన టోకెన్ల వివరాలు",
    meta_description: "తిరుపతి శ్రీవారి దర్శనం టోకెన్లు, లడ్డూ ప్రసాదం మరియు వసతి బుకింగ్ మార్గదర్శకాలు.",
    og_image: "https://images.unsplash.com/photo-1582510003544-4d00b7f74220?auto=format&fit=crop&w=1200&q=80",
    author_name: "VaartaNow Bhakti Desk",
    language: "te",
    published: true,
    featured: false,
  ...
  {
    slug: "warangal-textile-park-job-creation-2026",
    title: "వరంగల్ కాకతీయ మెగా టెక్స్‌టైల్ పార్క్: 15,000 మందికి నూతన ఉద్యోగావకాశాలు!",
    excerpt: "తెలంగాణ ద్వితీయ శ్రేణి నగరాల్లో పరిశ్రమల పెంపునకు గాను వరంగల్ టెక్స్‌టైల్ పార్క్‌లో ప్రముఖ కంపెనీల పెట్టుబడులు.",
    content: "## ఉపాధి అవకాశాలు\n\nవరంగల్ జిల్లా వ్యాప్తంగా యువతకు వస్త్ర పరిశ్రమ రంగంలో సాంకేతిక శిక్షణ మరియు ఉద్యోగాలు లభించనున్నాయి.",
    category: "jobs",
    tags: ["Warangal", "Telangana Jobs", "Kakatiya Textile Park", "Employment"],
    meta_title: "వరంగల్ టెక్స్‌టైల్ పార్క్ నూతన ఉద్యోగాలు",
    meta_description: "వరంగల్‌లో మెగా టెక్స్‌టైల్ పార్క్ అభివృద్ధి మరియు నూతన ఉద్యోగ నియామకాల సమాచారం.",
    og_image: "https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&w=1200&q=80",
    author_name: "VaartaNow Job Desk",
    language: "te",
    published: true,
    featured: false,
    reading_time_min: 3,
  ...
  {
    slug: "vizag-cruise-terminal-tourism-boost",
    title: "విశాఖపట్నం ఇంటర్నేషనల్ క్రూయిజ్ టెర్మినల్: సముద్ర పర్యాటకానికి కొత్త మైలురాయి!",
    excerpt: "విశాఖ తీరానికి చేరుకుంటున్న అంతర్జాతీయ విలాసవంతమైన క్రూయిజ్ నౌకలు, పర్యాటకరంగంలో భారీ ఆదాయం.",
    content: "## సాగర పర్యాటకం\n\nవిశాఖ ఆర్కే బీచ్, ఋషికొండ మరియు భీమిలి తీర ప్రాంతాలలో జలక్రీడలు మరియు టూరిజం కారిడార్లు అభివృద్ధి చేయబడ్డాయి.",
    category: "vizag",
    tags: ["Vizag", "Visakhapatnam", "Cruise Tourism", "Rushikonda"],
    meta_title: "విశాఖ క్రూయిజ్ టెర్మినల్ పర్యాటకం",
    meta_description: "విశాఖపట్నం సముద్ర పర్యాటకం, అంతర్జాతీయ క్రూయిజ్ సర్వీసులు మరియు బీచ్ రోడ్ విశేషాలు.",
    ...
    featured: true,
    reading_time_min: 3,
    published_at: minutesAgo(32)
  },
  {
    slug: "hyderabad-srh-ipl-2026-stadium-tickets",
    title: "ఉప్పల్ రాజీవ్ గాంధీ స్టేడియంలో ఐపీఎల్ సందడి: సన్‌రైజర్స్ హైదరాబాద్ టిక్కెట్ల సేల్స్ ప్రారంభం!",
    excerpt: "హైదరాబాద్ క్రికెట్ అభిమానులకు తీపి కబురు. ఉప్పల్ స్టేడియం మ్యాచ్‌ల కోసం ఆన్‌లైన్ టిక్కెట్ల వివరాలు విడుదల.",
    content: "## హైదరాబాద్ ఐపీఎల్ హడావుడి\n\nసన్‌రైజర్స్ హైదరాబాద్ (SRH) హోమ్ గ్రౌండ్ మ్యాచ్‌ల టిక్కెట్లను బుక్ చేసుకోవడానికి అభిమానులు ఆసక్తి చూపుతున్నారు.",
    category: "cricket",
    tags: ["Hyderabad", "SRH", "IPL 2026", "Uppal Stadium"],
    meta_title: "హైదరాబాద్ ఐపీఎల్ 2026 టిక్కెట్లు",
    meta_description: "సన్‌రైజర్స్ హైదరాబాద్ ఐపీఎల్ మ్యాచ్‌లు, ఉప్పల్ స్టేడియం టిక్కెట్ల బుకింగ్ సమాచారం.",
    og_image: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?auto=format&fit=crop&w=1200&q=80",
    author_name: "VaartaNow Sports Desk",
    language: "te",
    published: true,
    featured: false,
    reading_time_min: 2,
  ...
  {
    slug: "hyderabad-it-startup-ai-funding",
    title: "Hyderabad Tech Renaissance: AI & Cloud Startups Secure $120M Venture Funding",
    excerpt: "Hyderabad strengthens its position as India's premier AI hub with record venture capital investments in HITEC City.",
    content: "## Capital Inflow into Hyderabad\n\nGlobal investors pour funds into Hyderabad-based generative AI research labs and SaaS innovation units.\n\n## Talent Pool Growth\n\nTop tech talent from across India relocates to Gachibowli and Financial District for cutting-edge projects.",
    category: "technology",
    tags: ["Hyderabad", "Tech Startups", "AI Innovation", "HITEC City"],
    meta_title: "Hyderabad Tech Startups Secure $120M AI Funding",
    meta_description: "Hyderabad tech startups receive massive global VC funding for AI models and cloud software.",
    og_image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1200&q=80",
    author_name: "VarthaNow Tech Desk",
    language: "en",
    published: true,
    featured: true,
  ...
  {
    slug: "vijayawada-commercial-hub-expansion",
    title: "Vijayawada Emerges as Commercial Powerhouse with New Logistics Hub",
    excerpt: "Strategic location near Benz Circle and Auto Nagar drives rapid warehousing and logistics investments in Vijayawada.",
    content: "## Vijayawada Economic Blueprint\n\nThe expansion of Vijayawada airport at Gannavaram and inland dry ports creates thousands of regional trade jobs.\n\n## Real Estate Surge\n\nDemand for office space in MG Road and Kanuru scales to all-time highs.",
    category: "andhra-pradesh",
    tags: ["Vijayawada", "AP Business", "Gannavaram Airport", "Benz Circle"],
    meta_title: "Vijayawada Commercial Hub Expansion 2026",
    meta_description: "Vijayawada logistics, Gannavaram airport cargo hub, and retail business growth updates.",
    og_image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80",
    author_name: "VarthaNow Business Desk",
    language: "en",
    published: true,
    featured: false,
    reading_time_min: 3,
    published_at: minutesAgo(19)
  },
  {
    slug: "tirupati-spiritual-tourism-airport-expansion",
    title: "Tirupati International Airport Upgrade: Direct Flights to Singapore & Dubai Planned",
    excerpt: "Spiritual tourists worldwide gain direct access to Tirupati as aviation ministry sanctions runway extension.",
    content: "## Global Connectivity for Tirumala\n\nDevotees visiting Lord Venkateswara temple at Tirumala will benefit from streamlined international transit terminals.",
    category: "devotional",
    tags: ["Tirupati", "Tirumala", "Aviation", "Spiritual Tourism"],
    meta_title: "Tirupati Airport International Flights Expansion",
    meta_description: "Tirupati airport upgrades for direct international flights for Tirumala pilgrims.",
    og_image: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=1200&q=80",
    author_name: "VarthaNow Travel Desk",
    language: "en",
    published: true,
    featured: true,
    reading_time_min: 3,
    published_at: minutesAgo(26)
  }
];
