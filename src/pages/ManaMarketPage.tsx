...
export function ManaMarketPage() {
  ...
  return (
    <div className="bg-[hsl(var(--background))] text-[hsl(var(--foreground))] min-h-screen pb-12 transition-colors">
      <main className="container-shell py-6 space-y-6 animate-in fade-in duration-300">

        {/* Top Profile Header Bar */}
        <div className="flex flex-wrap items-center justify-between gap-3 bg-[hsl(var(--card))] p-4 rounded-3xl border border-[hsl(var(--border))] shadow-sm">
